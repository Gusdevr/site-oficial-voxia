...
const EMAIL = "gustavorodrigues@voxiatec.com.br";
    ...
    <div className="vx">
      ...
      <section id="fundador" className="section wrap">
        <div className="founder reveal">
          ...
          <div>
            ...
            <div className="links">
              <a className="flink" href={`mailto:${EMAIL}`}><Mail size={16} /> E-mail</a>
      ...
      <section id="contato" className="section wrap contact">
        <div className="reveal">
          ...
          <a className="mailbox" href={`mailto:${EMAIL}`}>
            <Mail size={18} /> <b>{EMAIL}</b>
          </a>
          <div>
            <a className="btn btn-primary" href={`mailto:${EMAIL}?subject=Contato%20VOX.IA`}>
